...
#         return response
        ...
        data1 = pd.read_csv("https://github.com/climateintelligence/shearwater/raw/main/data/test_dailymeans_Sindian_1.zip") # ("../shearwater/data/test_dailymeans_Sindian_1.zip")
        data2 = pd.read_csv("https://github.com/climateintelligence/shearwater/raw/main/data/test_dailymeans_Sindian_2.zip") # ("../shearwater/data/test_dailymeans_Sindian_2.zip")
        ...
        model_trained = models.load_model("https://github.com/climateintelligence/shearwater/raw/main/data/Unet_sevenAreas_fullStd_0lag_model.keras") # ('../shearwater/data/Unet_sevenAreas_fullStd_0lag_model.keras')
